...
def get_k4abt_module_path():
    ...
    return 'E:\\Program Files\\Azure Kinect Body Tracking SDK\\sdk\\windows-desktop\\amd64\\release\\bin\\k4abt.dll'
...
def get_k4abt_lite_model_path():
    ...
    return 'E:\\Program Files\\Azure Kinect Body Tracking SDK\\sdk\\windows-desktop\\amd64\\release\\bin\\dnn_model_2_0_lite_op11.onnx'.encode('utf-8')
