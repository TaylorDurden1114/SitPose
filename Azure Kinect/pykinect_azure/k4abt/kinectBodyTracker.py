...
class kinectBodyTracker:
	...
	def __init__(self, modulePath, sensor_calibration, modelType):
		...
		try:
			cdll.LoadLibrary("E:\\Program Files\\Azure Kinect Body Tracking SDK\\tools\\directml.dll")
		...
		if modelType == 1:
			try:
				_k4abt.K4ABT_TRACKER_CONFIG_DEFAULT.model_path = "E:\\Program Files\\Azure Kinect Body Tracking SDK\\sdk\\windows-desktop\\amd64\\release\\bin\\dnn_model_2_0_lite_op11.onnx".encode('utf-8')
			except Exception as e:
